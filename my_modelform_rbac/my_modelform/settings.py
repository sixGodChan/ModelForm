"""
Django settings for my_modelform project.
...
SECRET_KEY = '7=fzk@*#4tzh8(4=ry&16lpt=2%)9x(avjuzyg7kq5!&l9qxr@'
...
INSTALLED_APPS = [
    ...
    'sixgod.apps.SixgodConfig',  # 注册app
]
...
ROOT_URLCONF = 'my_modelform.urls'
...
WSGI_APPLICATION = 'my_modelform.wsgi.application'
